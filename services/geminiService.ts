...
export class GeminiService {
  private static MATERIAL_ANALYSIS_SCHEMA = {
    ...
    properties: {
      ...
      instruction: {
        type: Type.STRING,
        description: "Detailed disposal instructions mentioning specific Malaysian bin colors (Blue for Paper, Brown for Glass, Orange for Plastics/Metals).",
      },
      hazard_level: {
        type: Type.STRING,
        description: "The potential hazard level of the waste item (Low, Medium, High).",
      },
    },
    ...
    try {
      const response = await ai.models.generateContent({
        ...
        config: {
          ...
          responseSchema: this.MATERIAL_ANALYSIS_SCHEMA,
        },
      });
...
// Export for backward compatibility if needed, though App.tsx should be updated
